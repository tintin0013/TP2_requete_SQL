...
VALUES
    (1 , 1),
    (20 , 1),
    -- Tobey Maguire: Spider-Man, The Great Gatsby
    (20 , 2),
    ...
    (19 , 3),
    (22 , 3),
    -- Leonardo DiCaprio: The Great Gatsby, Shutter Island, Titanic, The Revenant, Inception
    (21 , 4),
    (12 , 4),
    -- Cillian Murphy: Dunkirk, The Dark Knight
    (18 , 5),
    ...
    (11 , 9),
    (15 , 9),
    -- Samuel L. Jackson: Pulp Fiction, Goodfellas
    (15 , 10),
    ...
    (19 , 14),
    (22 , 14),
    -- Tom Hardy: Dunkirk, The Dark Knight Rises, The Revenant, Inception
    (11 , 15),
    ...
    (3 , 19),
    (6 , 19),
    -- Ryan Gosling: La La Land, Blade Runner 2049
    (10 , 20),
    -- Al Pacino: The Godfather
    (14 , 21),
    (23 , 21);
-- Robin Wright: Forrest Gump, Wonder Woman
select *
from distribution;
